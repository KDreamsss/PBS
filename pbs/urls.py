...
urlpatterns = [
    ...
    path('friends-request/', user_views.friend_request_list, name='friend_request_list'),
    ...
    path('register/done/', user_views.register, name='register_done'),
    path('register/complete/', user_views.activate, name='register_complete'),
    path('users/delete/<int:id>', user_views.user_delete, name='users_delete'),
